...
- [X] T048 Verify the existing workflow defines the Linux/macOS/Windows release gate and prepare explicit PR/post-merge evidence fields in `specs/002-domain-models-schemas/implementation-notes.md`; populate live run URLs during publication after local convergence
